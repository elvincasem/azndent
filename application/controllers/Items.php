...
class Items extends CI_Controller
{
	...
	public function details($id)
	{
		...
		$data['itemcategorylist'] = $this->items_model->getitemcategorylist();
		$data['costhistory'] = $this->items_model->getcosthistory($id);
		$data['pricehistory'] = $this->items_model->getpricehistory($id);
	...
	public function saveitem(){
		...
		$this->items_model->saveitem($itemdescription,$unitofmeasure,$unitcost,$category,$supplierid,$brand,$warehouseid,$itemname,$part_number,$application,$price);
	}
	...
	public function updatecost(){
		...
		$this->items_model->updatecost($itemno,$unitcost);
	}
	...
	public function updateprice(){
		...
		$this->items_model->updateprice($itemno,$price);
	}
