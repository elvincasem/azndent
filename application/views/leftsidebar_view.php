                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                ...
                                <li class="<?php //echo $servicesclass;?>">
                                    ...
                                    <ul>
										<li>
                                            <a href="<?=base_url()?>estimate" class="<?php //echo $aprclass;?>"><i class="fa fa-bank sidebar-nav-icon"></i>Estimate of Repair</a>
                                        </li>
										<li>
                                            <a href="<?=base_url()?>purchaserequest" class="<?php echo $prclass;?>"><i class="fa fa-file-text-o sidebar-nav-icon"></i>Work Order</a>
                                        </li>
										<li>
                               ...
                               <!-- Asset Management -->
							   <li class="hidden <?php echo $assetmanagementclass;?>">
								...
								<li class="<?php echo $supplymanagementclass;?>">
                                    ...
                                    <ul>
										...
										<li>
                                            <a  href="<?=base_url()?>uom" class="<?php echo $adjustmentclass;?>"><i class="fa fa-briefcase sidebar-nav-icon"></i>Unit of Measure</a>
                                        </li>
