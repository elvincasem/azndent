			 ...
			 <!-- Regular Modal -->
                <div id="adddeliverymodal" class="modal bg" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md">
						...
						<label class="col-md-3 control-label text-right">Item Name</label>
                        <div class="col-md-7">
                            <input type="text" id="itemname" name="state-normal" class="form-control" tabindex="0" value="">
                        </div>	
						<label class="col-md-3 control-label text-right">Part Number</label>
                        <div class="col-md-7">
                            <input type="text" id="part_number" name="state-normal" class="form-control" tabindex="0" value="">
                        </div>	
						<label class="col-md-3 control-label text-right">Application</label>
                        <div class="col-md-7">
                            <input type="text" id="application" name="state-normal" class="form-control" tabindex="0" value="">
                        </div>	
						...
						<label class="col-md-3 control-label text-right">Price</label>
                        <div class="col-md-7">
                            <div class="input-group">
								<span class="input-group-addon">₱</span>
								<input type="text" id="price" name="example-input1-group1" class="form-control" placeholder="0.00">
							</div>
                        </div>	
