...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>Arzadon Service Billing System
</title>
    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <strong>Arzadon Service Billing System</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small> &copy; <a href="http://evenlyten.com" target="_blank">ASBS</a></small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
